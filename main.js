...
function startClassification(){
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/ZxzdNLOfr/model.json', modelReady);
}
...
function gotResults(error,results){
    if (error){
        ...
        if(results[0].label == "Clap"){
            img1 = document.getElementById("aliens-01.gif");
            img2 = document.getElementById("aliens-02.png");
            img3 = document.getElementById("aliens-03.png");
            img4 = document.getElementById("aliens-04.png"); 
            ...
            img1 = document.getElementById("aliens-01.png");
            img2 = document.getElementById("aliens-02.gif");
            img3 = document.getElementById("aliens-03.png");
            img4 = document.getElementById("aliens-04.png"); 
            ...
            img1 = document.getElementById("aliens-01.png");
            img2 = document.getElementById("aliens-02.png");
            img3 = document.getElementById("aliens-03.gif");
            img4 = document.getElementById("aliens-04.png"); 
            img1.src = 'aliens-01.png';
            img2.src = 'aliens-02.png';
            ...
            img2 = document.getElementById("aliens-02.png");
            img3 = document.getElementById("aliens-03.png");
            img4 = document.getElementById("aliens-04.gif"); 
            img1.src = 'aliens-01.png';
            img2.src = 'aliens-02.png';
            img3.src = 'aliens-03.png';
